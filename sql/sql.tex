...
reduce the work.
\subsubsection{Syntax}
\label{sec:org935251e}
\begin{verbatim}
use <database_name>;
\end{verbatim}
\subsubsection{Example}
\label{sec:orgeab1154}
\begin{verbatim}
use information_schema;
\end{verbatim}
\subsubsection{The magic}
\label{sec:orge337661}
...
\end{verbatim}
\section{Creating}
\label{sec:orgf9a7dc4}
\subsection{Databases}
\label{sec:org2998098}
\begin{verbatim}
create database login_db;
\end{verbatim}
\subsection{Tables}
\label{sec:org598a92e}
\subsubsection{Basic table}
\label{sec:org2d8d6e5}
\begin{verbatim}
create table info(
	username varchar(20),
...
It is of type \texttt{varchar(20)} (see table in \hyperref[sec:org253510b]{columns mostly used}).
...
\label{sec:orgfe763ea}

\section{Modifying}
\label{sec:org516719f}
